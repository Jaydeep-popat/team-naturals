      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-[3px] p-4"
            onClick={onClose}
          >
            {/* Modal card */}
            <motion.div
              ...
              className="relative w-full max-w-[380px] rounded-3xl bg-white p-8 shadow-[0_24px_80px_rgba(0,0,0,0.18)]"
