    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-[5.5rem] lg:bottom-8 left-1/2 z-[100] flex w-[calc(100vw-8.5rem)] sm:w-max items-center justify-between lg:justify-center rounded-full bg-[#348C31] p-1.5 pr-4 sm:pr-5 shadow-2xl shadow-[#348C31]/40"
        >
